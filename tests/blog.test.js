...
describe('GET /api/blogs', () => {
    return it('should return all blogs', async () => {
...
describe("POST /api/blogs", () => {
    return it("should post a blog to database", async () => {
...
describe("PUT /api/blogs/:id", () => {
    return it("should update blog title", async () => {
...
describe("DELETE /api/blogs/:id", () => {
    return it("should delete a blog", async () => {
        const blog = await Blog.findOne();
